...
sudo apt install ranger kitty neofetch gimp chromium obs-studio neovim zsh fwupd python3 python3-tk python3-pip python3-pylsp sqlite3 emacs cmake libtool ripgrep solaar vlc audacious ubuntu-restricted-extras htop btop nodejs npm redshift -y
